...
TITLE   = "morpheus-cam"
TAGLINE = "real-time body-driven Stable Diffusion  ·  NPU + iGPU + CUDA"
FOOTER  = "Unveil Studio  ·  MIT License"

# Accent color: violet — distinguishes morpheus-cam (body-driven) from
# wgsl-shm (coral), NDIForPython (cyan) and SPOUT2ForPython (purple).
# Same swatch used by control/panel.html.
ACCENT = (168, 85, 247)
GLOW   = (80, 30, 130)
...
def main() -> None:
    ...
    title_font   = _font("bold", 72)
    tagline_font = _font("regular", 26)
